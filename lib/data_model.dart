import 'package:flutter/material.dart';
  ...
  class Transactions1 extends ChangeNotifier{
    ...
    List<Transactions> items=[  Transactions(amount: '1000', name:'Grocery',desc: 'Few items remaining',icon:Icons.local_grocery_store),
...
class Transactions{
  ...
  final IconData icon;
  String? desc;
  Transactions({required this.amount,required this.name,this.desc,required this.icon});

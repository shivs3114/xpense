        ...
        Theme.of(context).colorScheme.primary,]),
           ...
           ,GestureDetector(onTap: (){},
            ...
            ,
                ...
                // Your code for the UI components here
                Expanded(
                  child: ListView.builder(
                    itemCount: transactions.Items.length,
                    
                    itemBuilder: (context, index) {
                      final i=transactions.Items.length - 1 - index;
                      return Padding(
                          ...
                          children: [
                                ...
                                Padding(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      Icon(transactions.Items[i].icon)
                                    ],
                                  ),
                                ),
                                SizedBox(width: 10),
                                Text(
                                  transactions.Items[i].name,
                                  style: TextStyle(
                                      fontSize: 16,
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    '-₹${transactions.Items[i].amount}',
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold),
                                  ),
                                transactions.Items[i].date!=null ? (Text(transactions.Items[i].date)):Text('2/09/2024'),
                                ],
                              ),
                            ),
                          ],
